...
require (
	...
	github.com/tom-draper/api-analytics/server/tools/monitor v0.0.0-20241006164721-fea8ceacee14
...
require (
	...
	github.com/tom-draper/api-analytics/server/database v0.0.0-20241006164721-fea8ceacee14 // indirect
