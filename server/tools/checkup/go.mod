...
require (
	...
	github.com/tom-draper/api-analytics/server/tools/monitor v0.0.0-20240122185718-6c258ea65a85
	github.com/tom-draper/api-analytics/server/tools/usage v0.0.0-20240122185718-6c258ea65a85
