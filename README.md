...
Active API monitoring can be set up by heading to https://apianalytics.dev/monitoring and entering you API key. Our servers will regularly ping chosen API endpoints to monitor uptime and response time. 
