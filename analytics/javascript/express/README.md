...
[![npm](https://img.shields.io/npm/v/@api-analytics/express)](https://www.npmjs.com/package/@api-analytics/express)
...
```js
import express from 'express';
import { expressAnalytics, Config } from '@api-analytics/express';
...
app.use(expressAnalytics('YOUR-API-KEY', config));  // Add middleware
```
