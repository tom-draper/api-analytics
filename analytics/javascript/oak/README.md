...
[![JSR](https://jsr.io/badges/@api-analytics/oak)](https://jsr.io/@api-analytics/oak)

```bash
deno add @api-analytics/oak
```
...
A config object can be passed to override default behaviour.
