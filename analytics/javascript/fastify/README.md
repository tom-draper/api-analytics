...
[![npm](https://img.shields.io/npm/v/@api-analytics/fastify)](https://www.npmjs.com/package/@api-analytics/fastify)

```bash
npm install @api-analytics/fastify
```
...
fastifyAnalytics(fastify, 'YOUR-API-KEY');  // Add middleware
...
```js
import Fastify from 'fastify';
import { fastifyAnalytics, Config } from '@api-analytics/fastify';
...
fastifyAnalytics(fastify, 'YOUR-API-KEY', config);  // Add middleware
```
