...
import { elysiaAnalytics } from '@api-analytics/elysia';

const app = new Elysia();

elysiaAnalytics(app, 'YOUR-API-KEY');  // Add middleware
...
```js
import { Elysia } from 'elysia';
import { elysiaAnalytics, Config } from '@api-analytics/elysia';
...
elysiaAnalytics(app, 'YOUR-API-KEY', config);  // Add middleware
```
