...
[![npm](https://img.shields.io/npm/v/@api-analytics/h3)](https://www.npmjs.com/package/@api-analytics/h3)

```bash
npm install @api-analytics/h3
```
...
app.use(h3Analytics('YOUR-API-KEY'));  // Add middleware

const router = createRouter();
router.get('/', defineEventHandler(() => ({ message: 'Hello World!' })));
app.use(router);
```
...
import { h3Analytics, Config } from '@api-analytics/h3';
...
app.use(h3Analytics('YOUR-API-KEY', config));  // Add middleware
```
