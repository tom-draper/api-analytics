<div class="info-page-container text-[#c3c3c3] text-center leading-snug">
	<h1>Privacy Policy</h1>

	<div class="text-[#707070]">Last updated: 2024-09-20</div>
	...
	<p>
		...
		all associated data by going to <a href="https://apianalytics.dev/delete">https://apianalytics.dev/delete</a> and entering your API key.
	</p>
