const faq = [
    ...
    },
    {
        ...
        answer: 'Account creation is complete free. In future, we transition to a fremium service with the introduction of a paid tier, but a free tier will always remain available.',
        showing: false,
    },
    {
