<script lang="ts">
	...
	function computeOverall(data: RequestsData, resiliance: number, performance: number, adoption: number) {
		const resilianceWeight = 0.3;
		const performanceWeight = 0.3;
		const adoptionWeight = 0.4;
		const overall = (resiliance * resilianceWeight + performance * performanceWeight + adoption * adoptionWeight);
		return overall;
	}
...
<div class="card">
	...
	<div class="health-container flex flex-row pb-4 px-4">
		<div class="health-item flex-1 grid place-items-center">
