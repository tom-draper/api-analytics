...
const PastMonth = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div id="${"plotly"}"><div id="${"requestsFreqPlotDiv"}"${add_attribute("this", requestsFreqPlotDiv, 0)}></div></div>
  <div id="${"plotlyy"}"><div id="${"responseTimePlotDiv"}"${add_attribute("this", responseTimePlotDiv, 0)}></div></div>
  <div class="${"success-rate-container svelte-ik169t"}">${successRate != undefined
	? `<div class="${"success-rate-title"}">Success rate</div>
      <div class="${"errors svelte-ik169t"}">${each(successRate, (value, i) => {
			return `<div class="${"error svelte-ik169t"}" style="${"background: " + escape(colors[Math.floor(value * 10)], true)}" title="${escape((value * 100).toFixed(1), true) + "%"}"></div>`;
		})}</div>`
	: ``}</div>
</div>`;
});
...
const Dashboard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div>
  ${data != undefined
	? `<div class="${"dashboard svelte-1n7lknr"}"><div class="${"left"}"><div class="${"two-row svelte-1n7lknr"}">${validate_component(Requests, "Requests").$$render($$result, { data }, {}, {})}
      ...
      <div class="${"right svelte-1n7lknr"}">${validate_component(PastMonth, "PastMonth").$$render($$result, { data }, {}, {})}</div></div>`
	: ``}
