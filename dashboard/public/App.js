...
const css$7 = {
	code: ".card.svelte-xrcm7o{min-height:361px}.endpoints.svelte-xrcm7o{margin:1em 20px 0.6em}.endpoint.svelte-xrcm7o{border-radius:3px;margin:6px 0;color:var(--light-background);text-align:left;position:relative}.endpoint-label.svelte-xrcm7o{display:flex}.path.svelte-xrcm7o,.count.svelte-xrcm7o{padding:3px 15px}.path.svelte-xrcm7o{flex-grow:1}.endpoint-container.svelte-xrcm7o{display:flex}.external-label.svelte-xrcm7o{padding:3px 15px;left:40px;top:0;margin:6px 0;color:#707070;display:none}",
...
const Endpoints = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"card svelte-xrcm7o"}"><div class="${"card-title"}">Endpoints</div>
  ${endpoints != undefined
	? `<div class="${"endpoints svelte-xrcm7o"}">${each(endpoints, (endpoint, i) => {
			return `<div class="${"endpoint-container svelte-xrcm7o"}"><div class="${"endpoint svelte-xrcm7o"}" id="${"endpoint-" + escape(i, true)}" style="${"width: " + escape(endpoint.count / maxCount * 100, true) + "%; background: " + escape(
				endpoint.status >= 200 && endpoint.status <= 299
				? 'var(--highlight)'
				: '#e46161',
				true
			)}"><div class="${"endpoint-label svelte-xrcm7o"}" id="${"endpoint-label-" + escape(i, true)}"><div class="${"path svelte-xrcm7o"}" id="${"endpoint-path-" + escape(i, true)}">${escape(endpoint.path)}</div>
              <div class="${"count svelte-xrcm7o"}" id="${"endpoint-count-" + escape(i, true)}">${escape(endpoint.count)}</div>
            </div></div>
          <div class="${"external-label svelte-xrcm7o"}" id="${"external-label-" + escape(i, true)}"><div class="${"external-label-path"}">${escape(endpoint.path)}
            </div></div>
        </div>`;
		})}</div>`
	: ``}
...
const Browser = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"card svelte-1xifokj"}" title="${"Last week"}"><div class="${"card-title"}">Browser</div>
  <div id="${"plotly"}"><div id="${"plotDiv"}" class="${"svelte-1xifokj"}"${add_attribute("this", plotDiv, 0)}></div></div>
</div>`;
});
...
const OperatingSystem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"card svelte-1b4x1x7"}" title="${"Last week"}"><div class="${"card-title"}">OS</div>
  <div id="${"plotly"}"><div id="${"plotDiv"}" class="${"svelte-1b4x1x7"}"${add_attribute("this", plotDiv, 0)}></div></div>
</div>`;
});
...
const css$1 = {
	code: ".card.svelte-lc80sr{margin:2em 0;padding-bottom:1em;flex:1}#plotDiv.svelte-lc80sr{margin-right:20px}",
	map: "{\"version\":3,\"file\":\"Device.svelte\",\"sources\":[\"Device.svelte\"],\"sourcesContent\":[\"<script lang=\\\"ts\\\">import { onMount } from \\\"svelte\\\";\\r\\nfunction getDevice(userAgent) {\\r\\n    if (userAgent.match(/iPhone/)) {\\r\\n        return 'iPhone';\\r\\n    }\\r\\n    else if (userAgent.match(/Android/)) {\\r\\n        return 'Android';\\r\\n    }\\r\\n    else if (userAgent.match(/Tizen\\\\//)) {\\r\\n        return 'Samsung';\\r\\n    }\\r\\n    else {\\r\\n        return 'Other';\\r\\n    }\\r\\n}\\r\\nfunction devicePlotLayout() {\\r\\n    return {\\r\\n        title: false,\\r\\n        autosize: true,\\r\\n        margin: { r: 35, l: 70, t: 10, b: 20, pad: 0 },\\r\\n        hovermode: \\\"closest\\\",\\r\\n        plot_bgcolor: \\\"transparent\\\",\\r\\n        paper_bgcolor: \\\"transparent\\\",\\r\\n        height: 180,\\r\\n        yaxis: {\\r\\n            title: { text: \\\"Requests\\\" },\\r\\n            gridcolor: \\\"gray\\\",\\r\\n            showgrid: false,\\r\\n            fixedrange: true,\\r\\n        },\\r\\n        xaxis: {\\r\\n            visible: false,\\r\\n        },\\r\\n        dragmode: false,\\r\\n    };\\r\\n}\\r\\nlet colors = [\\r\\n    \\\"#3FCF8E\\\",\\r\\n    \\\"#E46161\\\",\\r\\n    \\\"#EBEB81\\\", // Yellow\\r\\n];\\r\\nfunction pieChart() {\\r\\n    let deviceCount = {};\\r\\n    for (let i = 0; i < data.length; i++) {\\r\\n        let browser = getDevice(data[i].user_agent);\\r\\n        if (!(browser in deviceCount)) {\\r\\n            deviceCount[browser] = 0;\\r\\n        }\\r\\n        deviceCount[browser]++;\\r\\n    }\\r\\n    let device = [];\\r\\n    let count = [];\\r\\n    for (let browser in deviceCount) {\\r\\n        device.push(browser);\\r\\n        count.push(deviceCount[browser]);\\r\\n    }\\r\\n    return [{\\r\\n            values: count,\\r\\n            labels: device,\\r\\n            type: 'pie',\\r\\n            marker: {\\r\\n                colors: colors\\r\\n            },\\r\\n        }];\\r\\n}\\r\\nfunction devicePlotData() {\\r\\n    return {\\r\\n        data: pieChart(),\\r\\n        layout: devicePlotLayout(),\\r\\n        config: {\\r\\n            responsive: true,\\r\\n            showSendToCloud: false,\\r\\n            displayModeBar: false,\\r\\n        },\\r\\n    };\\r\\n}\\r\\nfunction genPlot() {\\r\\n    let plotData = devicePlotData();\\r\\n    //@ts-ignore\\r\\n    new Plotly.newPlot(plotDiv, plotData.data, plotData.layout, plotData.config);\\r\\n}\\r\\n//   function build() {\\r\\n//     let totalRequests = 0;\\r\\n//     for (let i = 0; i < data.length; i++) {\\r\\n//       let date = new Date(data[i].created_at);\\r\\n//       if (thisWeek(date)) {\\r\\n//         totalRequests++;\\r\\n//       }\\r\\n//     }\\r\\n//     requestsPerHour = ((24 * 7) / totalRequests).toFixed(2);\\r\\n//   }\\r\\nlet plotDiv;\\r\\nonMount(() => {\\r\\n    genPlot();\\r\\n});\\r\\nexport let data;\\r\\n</script>\\r\\n\\r\\n<div class=\\\"card\\\" title=\\\"Last week\\\">\\r\\n  <div class=\\\"card-title\\\">Device</div>\\r\\n  <div id=\\\"plotly\\\">\\r\\n    <div id=\\\"plotDiv\\\" bind:this={plotDiv}>\\r\\n      <!-- Plotly chart will be drawn inside this DIV -->\\r\\n    </div>\\r\\n  </div>\\r\\n</div>\\r\\n\\r\\n<style>\\r\\n  .card {\\r\\n    margin: 2em 0;\\r\\n    padding-bottom: 1em;\\r\\n    flex: 1;\\r\\n  }\\r\\n  #plotDiv {\\r\\n    margin-right: 20px;\\r\\n  }\\r\\n\\r\\n</style>\\r\\n\"],\"names\":[],\"mappings\":\"AA4GE,KAAK,cAAC,CAAC,AACL,MAAM,CAAE,GAAG,CAAC,CAAC,CACb,cAAc,CAAE,GAAG,CACnB,IAAI,CAAE,CAAC,AACT,CAAC,AACD,QAAQ,cAAC,CAAC,AACR,YAAY,CAAE,IAAI,AACpB,CAAC\"}"
};
...
const Device = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"card svelte-lc80sr"}" title="${"Last week"}"><div class="${"card-title"}">Device</div>
  <div id="${"plotly"}"><div id="${"plotDiv"}" class="${"svelte-lc80sr"}"${add_attribute("this", plotDiv, 0)}></div></div>
</div>`;
});
	...
	? `<div class="${"dashboard svelte-95rck4"}"><div class="${"left"}"><div class="${"row svelte-95rck4"}">${validate_component(Requests, "Requests").$$render($$result, { data }, {}, {})}
      ...
      <div class="${"right svelte-95rck4"}">${validate_component(PastMonth, "PastMonth").$$render($$result, { data }, {}, {})}
        <div class="${"row svelte-95rck4"}">${validate_component(OperatingSystem, "OperatingSystem").$$render($$result, { data }, {}, {})}
          ...
          ${validate_component(Browser, "Browser").$$render($$result, { data }, {}, {})}
          ${validate_component(Device, "Device").$$render($$result, { data }, {}, {})}</div></div></div>`
	: ``}
