...
<div class="${"home svelte-1k5uj5m"}"><div class="${"landing-page-container svelte-1k5uj5m"}"><div class="${"landing-page svelte-1k5uj5m"}"><div class="${"left svelte-1k5uj5m"}"><h1 class="${"svelte-1k5uj5m"}">API Analytics</h1>
        <h2 class="${"svelte-1k5uj5m"}">Monitoring and analytics for API frameworks.</h2>
        <div class="${"links svelte-1k5uj5m"}"><a href="${"/generate"}" class="${"link svelte-1k5uj5m"}"><div class="${"text"}">Try now – it&#39;s <span class="${"italic svelte-1k5uj5m"}">free</span></div></a>
          <a href="${"/dashboard/demo"}" class="${"link secondary svelte-1k5uj5m"}"><div class="${"text"}">Demo</div></a></div></div>
      <div style="${"position: relative"}" class="${"right svelte-1k5uj5m"}"><img class="${"logo svelte-1k5uj5m"}" src="${"img/home-logo2.png"}" alt="${""}">
        <img id="${"hover-1"}" style="${"position: absolute;"}" class="${"logo svelte-1k5uj5m"}" src="${"img/animated5.png"}" alt="${""}">
        <img id="${"hover-2"}" style="${"position: absolute;"}" class="${"logo svelte-1k5uj5m"}" src="${"img/animated6.png"}" alt="${""}"></div></div></div>

  <div class="${"dashboard svelte-1k5uj5m"}"><div class="${"dashboard-title-container svelte-1k5uj5m"}"><img class="${"lightning-top svelte-1k5uj5m"}" src="${"img/logo.png"}" alt="${""}">
      <h1 class="${"dashboard-title svelte-1k5uj5m"}">Dashboard</h1></div>
    <div class="${"dashboard-content svelte-1k5uj5m"}"><div class="${"dashboard-content-text svelte-1k5uj5m"}">An all-in-one analytics dashboard. Real-time insight into your API&#39;s
        usage.
      </div>
      <div class="${"dashboard-btn-container svelte-1k5uj5m"}"><a href="${"/dashboard"}" class="${"dashboard-btn secondary svelte-1k5uj5m"}"><div class="${"dashboard-btn-text svelte-1k5uj5m"}">Open</div></a></div></div>
    <img class="${"dashboard-img svelte-1k5uj5m"}" src="${"img/dashboard.png"}" alt="${""}"></div>
  <div class="${"dashboard svelte-1k5uj5m"}"><div class="${"dashboard-title-container svelte-1k5uj5m"}"><img class="${"lightning-top svelte-1k5uj5m"}" src="${"img/logo.png"}" alt="${""}">
      <h1 class="${"dashboard-title svelte-1k5uj5m"}">Monitoring</h1></div>
    <div class="${"dashboard-content svelte-1k5uj5m"}"><div class="${"dashboard-content-text svelte-1k5uj5m"}">Active monitoring and error notifications. Peace of mind.
      </div>
      <div class="${"dashboard-btn-container svelte-1k5uj5m"}"><a href="${"/"}" class="${"dashboard-btn secondary svelte-1k5uj5m"}"><div class="${"dashboard-btn-text svelte-1k5uj5m"}">Coming Soon</div></a></div></div>
    <img class="${"dashboard-img svelte-1k5uj5m"}" src="${"img/monitoring.png"}" alt="${""}"></div>
  <div class="${"add-middleware svelte-1k5uj5m"}"><div class="${"add-middleware-title svelte-1k5uj5m"}">Getting Started</div>
    <div class="${"frameworks svelte-1k5uj5m"}"><button class="${["framework python svelte-1k5uj5m", "active" ].join(' ').trim()}">Django</button>
      <button class="${["framework python svelte-1k5uj5m", ""].join(' ').trim()}">Flask</button>
      <button class="${["framework python svelte-1k5uj5m", ""].join(' ').trim()}">FastAPI</button>
      <button class="${["framework python svelte-1k5uj5m", ""].join(' ').trim()}">Tornado</button>
      <button class="${["framework javascript svelte-1k5uj5m", ""].join(' ').trim()}">Express</button>
      <button class="${["framework javascript svelte-1k5uj5m", ""].join(' ').trim()}">Fastify</button>
      <button class="${["framework javascript svelte-1k5uj5m", ""].join(' ').trim()}">Koa</button>
      <button class="${["framework golang svelte-1k5uj5m", ""].join(' ').trim()}">Gin</button>
      <button class="${["framework golang svelte-1k5uj5m", ""].join(' ').trim()}">Echo</button>
      <button class="${["framework golang svelte-1k5uj5m", ""].join(' ').trim()}">Fiber</button>
      <button class="${["framework golang svelte-1k5uj5m", ""].join(' ').trim()}">Chi</button>
      <button class="${["framework rust svelte-1k5uj5m", ""].join(' ').trim()}">Actix</button>
      <button class="${["framework rust svelte-1k5uj5m", ""].join(' ').trim()}">Axum</button>
      <button class="${["framework ruby svelte-1k5uj5m", ""].join(' ').trim()}">Rails</button>
      <button class="${["framework ruby svelte-1k5uj5m", ""].join(' ').trim()}">Sinatra</button></div>
    <div class="${"add-middleware-content"}"><div class="${"instructions-container svelte-1k5uj5m"}"><div class="${"instructions svelte-1k5uj5m"}"><div class="${"subtitle svelte-1k5uj5m"}">Install</div>
          <code class="${"installation svelte-1k5uj5m"}">${escape(frameworkExamples[framework].install)}</code>
          <div class="${"subtitle svelte-1k5uj5m"}">Add middleware to API</div>
          
          
          <div class="${"code-file svelte-1k5uj5m"}">${escape(frameworkExamples[framework].codeFile)}</div>
          <code id="${"code"}" class="${"code language-python svelte-1k5uj5m"}" style="${escape('display: initial' , true) + ""}">${escape(frameworkExamples["Django"].example)}</code>
          <code id="${"code"}" class="${"code language-python svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["FastAPI"].example)}</code>
          <code id="${"code"}" class="${"code language-python svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Flask"].example)}</code>
          <code id="${"code"}" class="${"code language-python svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Tornado"].example)}</code>
          <code id="${"code"}" class="${"code language-javascript svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Express"].example)}</code>
          <code id="${"code"}" class="${"code language-javascript svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Fastify"].example)}</code>
          <code id="${"code"}" class="${"code language-javascript svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Koa"].example)}</code>
          <code id="${"code"}" class="${"code language-go svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Gin"].example)}</code>
          <code id="${"code"}" class="${"code language-go svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Echo"].example)}</code>
          <code id="${"code"}" class="${"code language-go svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Fiber"].example)}</code>
          <code id="${"code"}" class="${"code language-go svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Chi"].example)}</code>
          <code id="${"code"}" class="${"code language-rust svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Actix"].example)}</code>
          <code id="${"code"}" class="${"code language-rust svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Axum"].example)}</code>
          <code id="${"code"}" class="${"code language-ruby svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Rails"].example)}</code>
          <code id="${"code"}" class="${"code language-ruby svelte-1k5uj5m"}" style="${escape('', true) + ""}">${escape(frameworkExamples["Sinatra"].example)}</code></div></div></div></div></div>
